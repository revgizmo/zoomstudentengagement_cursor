...
## Step 6: Name Matching with Privacy Protection

The package uses a privacy-first approach for name matching. When names in your Zoom transcript don't match your roster, the system will stop and ask you to create mappings to protect student privacy.
...
```{r safe-workflow}
# Use the safe name matching workflow
tryCatch(
  {
    safe_results <- safe_name_matching_workflow(
    ...
    cat("Results are privacy-masked by default.\n")
  },
  error = function(e) {
    cat("Name matching error:\n")
    cat(e$message, "\n")
    cat("\nTo resolve this:\n")
    cat("1. Check the error message for unmatched names\n")
    cat("2. Update your section_names_lookup.csv file\n")
    cat("3. Re-run the workflow\n")
    cat("4. See vignette('name-matching-troubleshooting') for detailed help\n")
  }
)
```
