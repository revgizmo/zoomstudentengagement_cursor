...
# Write the mapping file (safe transactional helper)
write_lookup_transactional(
  df = read_lookup_safely("section_names_lookup.csv") |> merge_lookup_preserve(cross_session_mapping),
  path = "section_names_lookup.csv"
)
```
...
# Write the mapping file (safe transactional helper)
write_lookup_transactional(
  df = read_lookup_safely("section_names_lookup.csv") |> merge_lookup_preserve(variation_mapping),
  path = "section_names_lookup.csv"
)
```
