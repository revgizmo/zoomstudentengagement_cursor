...
plot_users(transcripts_summary_df, metric = "perc_n", facet_by = "section", mask_by = "name")

# Plot percentage of speaking time
plot_users(transcripts_summary_df, metric = "perc_duration", facet_by = "section", mask_by = "name")

# Plot percentage of words
plot_users(transcripts_summary_df, metric = "perc_wordcount", facet_by = "section", mask_by = "name")
```
