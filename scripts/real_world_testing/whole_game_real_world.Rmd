...
if (exists("clean_metrics")) {
  write.csv(clean_metrics, "outputs/clean_engagement_metrics.csv", row.names = FALSE)
  cat("Saved: outputs/clean_engagement_metrics.csv\n")
}

# Save the student summary
if (exists("student_summary")) {
  write.csv(student_summary, "outputs/student_participation_summary.csv", row.names = FALSE)
  cat("Saved: outputs/student_participation_summary.csv\n")
}

# Save the name mappings
if (exists("custom_mappings")) {
  write.csv(custom_mappings, "outputs/name_mappings.csv", row.names = FALSE)
