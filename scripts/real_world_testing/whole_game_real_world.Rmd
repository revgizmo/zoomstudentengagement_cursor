...
if (file.exists(lookup_file)) {
  cat("=== Existing Name Lookup Configuration ===\n")
  ...
  cat("=== Creating Instructor Configuration ===\n")
  cat("No section_names_lookup.csv found. Creating one with instructor configuration.\n")
  
  # Create a basic lookup file with instructor configuration
  instructor_lookup <- data.frame(
    transcript_name = c("Conor Healy", "Prof. Healy", "Dr. Healy", "Professor Healy"),
    preferred_name = c("Conor Healy", "Conor Healy", "Conor Healy", "Conor Healy"),
    formal_name = c("Conor Healy", "Conor Healy", "Conor Healy", "Conor Healy"),
    participant_type = c("instructor", "instructor", "instructor", "instructor"),
    student_id = c("INSTRUCTOR", "INSTRUCTOR", "INSTRUCTOR", "INSTRUCTOR"),
    notes = c("Primary instructor name", "Title variation", "Title variation", "Title variation"),
    stringsAsFactors = FALSE
  )
  
  # Save the instructor configuration
...
cat("The section_names_lookup.csv file should contain:\n")
...
cat("\nCommon instructor name variations to add:\n")
cat("- 'Conor Healy', 'Prof. Healy', 'Dr. Healy', 'Professor Healy'\n")
cat("- 'Instructor', 'Host', 'Moderator' (if Zoom shows generic names)\n")
```
...
if (exists("student_summary") && nrow(student_summary) > 0) {
  ...
  if (exists("p1")) {
    ...
    cat("Plot saved: participation_by_utterances.png\n")
  }
  if (exists("p2")) {
    ggsave("participation_by_duration.png", p2, width = 10, height = 8)
    cat("Plot saved: participation_by_duration.png\n")
  }
} else {
