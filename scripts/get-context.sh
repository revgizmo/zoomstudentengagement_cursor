...
echo ""
echo "1️⃣  Run pre-PR checks to get current metrics:"
echo "   devtools::check()"
echo "   devtools::test()"
echo "   covr::package_coverage()"
echo ""
echo "2️⃣  Run context scripts to generate fresh context:"
echo "   ./scripts/save-context.sh"
echo ""
echo "3️⃣  Update PROJECT.md based on @full-context.md:"
echo "   • Read the discrepancy information above"
echo "   • Update PROJECT.md with current metrics"
echo "   • Update date to $(date '+%Y-%m-%d')"
echo ""
echo "💡 TIP: The context scripts show exactly what needs updating!"
