test_that("make_blank_cancelled_classes_df returns correct structure and is empty", {
  ...
  expect_type(result$`File Count`, "double")
  expect_type(result$`Total Views`, "double")
  expect_type(result$`Total Downloads`, "double")
  expect_type(result$`Last Accessed`, "double")
