...
test_that("consolidate_transcript performance with large datasets", {
  ...
  expect_true(
    execution_time < 15,
    sprintf("consolidate_transcript should complete in <15 seconds, took %.3f seconds", execution_time)
  )
...
test_that("summarize_transcript_metrics performance with large datasets", {
  ...
  expect_true(
    execution_time < 15,
    sprintf("summarize_transcript_metrics should complete in <15 seconds, took %.3f seconds", execution_time)
  )
